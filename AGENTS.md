...
- Never place Alpaca live credentials in the runtime. All trading must remain disabled until a dedicated paper account, per-bot attribution, and reconciliation are verified.
