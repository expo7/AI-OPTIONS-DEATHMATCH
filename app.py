...
<p>AI Options Deathmatch is an upcoming public experiment. Four AI strategy candidates and a deterministic cash benchmark are preparing to compete. Each will begin with ${STARTING_CASH_CENTS / 100:,.0f} in separate virtual capital. Their complete paper-trading records will appear here.</p>
...
<h2>Generation 1 candidate roster</h2><p>These approaches are provisional. Configurations and competition rules will be frozen before the first trade.</p><section class="roster" aria-label="Candidate bots">{cards}</section><p><a href="https://github.com/expo7/AI-OPTIONS-DEATHMATCH">Read the project plan</a></p></main></body></html>'''.encode()
        self.send_response(200)
